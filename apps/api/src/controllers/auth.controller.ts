...
export class AuthController {
  ...
  static async register(req: Request, res: Response) {
    ...
    try {
      ...
      console.log("[AuthController] Data validated successfully", validatedData);
  
      // Call AuthService to create a new user and return the token
      const { user, token } = await AuthService.createUser(firstName, lastName, email, password);
      console.log("[AuthController] User created successfully", user);
  ...
  static async login(req: Request, res: Response) {
    ...
    try {
      ...
      console.log("[AuthController] User authenticated successfully", { email, token });
